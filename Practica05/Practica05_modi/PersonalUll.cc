...
bool PersonalUll::operator==(const PersonalUll& other) const { return static_cast<long>(*this) == static_cast<long>(other) && nombre_ == other.nombre_ && apellido1_ == other.apellido1_ && apellido2_ == other.apellido2_;  }
bool PersonalUll::operator!=(const PersonalUll& other) const { return static_cast<long>(*this) != static_cast<long>(other) && nombre_ != other.nombre_ && apellido1_ != other.apellido1_ && apellido2_ != other.apellido2_; }
bool PersonalUll::operator<(const PersonalUll& other) const { return static_cast<long>(*this) < static_cast<long>(other); }
bool PersonalUll::operator>(const PersonalUll& other) const { return static_cast<long>(*this) > static_cast<long>(other); }
bool PersonalUll::operator<=(const PersonalUll& other) const { return static_cast<long>(*this) <= static_cast<long>(other); }
bool PersonalUll::operator>=(const PersonalUll& other) const { return static_cast<long>(*this) >= static_cast<long>(other); }