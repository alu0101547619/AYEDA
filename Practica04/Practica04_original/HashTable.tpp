...
class HashTable : public Sequence<Key> {
  public:
    ...
    virtual bool isFull() const override; // Función que indica si la tabla está llena
...
/**
 * @brief Función que indica si la tabla está llena.
 * @tparam Key Tipo de dato de la clave.
 * @tparam Container Tipo de contenedor.
 * @return bool Devuelve true si la tabla está llena, false en caso contrario.
 */
template <class Key, class Container>
